...
def findDistance(r1,c1,r2,c2): #will be used for corner updation
	d = (r1-r2)**2 + (c1-c2)**2
	d = d**0.5
	return d
...
while True:
	while True:
		...
		cv2.putText(frame,'Press a to start tracking',(10,20),cv2.FONT_HERSHEY_SIMPLEX,1,color = (60,100,75),thickness = 3)
		...
		new_corners = cv2.goodFeaturesToTrack(roi,50,0.01,10) #finding corners
	...
	while True:
		...
		#added only those corners to new corners updated which are at a distance of 30 or lesse
		...
		cv2.putText(frame,'Tracking percentage : Excellent %04.3f'%random.random(),(20,50),cv2.FONT_HERSHEY_SIMPLEX,1,color = (200,50,75),thickness = 3)
		cv2.imshow('tracker',frame)
